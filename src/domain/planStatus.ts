 ...
 *
 * Robbie, Ari and Morgan all exist as seeded profiles from first launch, so a
 * friend who has never sent their picks looked identical to a friend with an
 * empty day: available all afternoon. "No data" must never render as "free",
