...
Robbie, Ari and Morgan exist as seeded profiles from first launch, so "profile
exists" never meant "plan is on this phone".

```ts
planInfo('ari', settings, selections)
...
source — "Ari, manual check-in at Ghost Stage, updated 6 minutes ago", never
"Ari planned at Ghost Stage".
